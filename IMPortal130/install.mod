...
##                 phpbbroot/templates/scripts.js
...
##                 phpbbroot/templates/subSilver/layout/
##                 phpbbroot/templates/subSilver/layout/
##                 phpbbroot/templates/subSilver/layout/
##                 phpbbroot/templates/subSilver/layout/
...
## MOD History:
## 
##   2012-09-19 - Version 1.2.3 BETA (MWE_001 - http://www.integramod.com)
## 
...
copy phpbbroot/templates/scripts.js to phpbbroot/templates/scripts.js
...
execute portalinstall.php using your browser when logged in as admin Example: http://yoursite.com/installer.php
...
#
//
// IM Portal http://www.e-tegra.com
//
...
#-----[ AFTER, ADD ]------------------------------------------
#
<script language="javascript" type="text/javascript" src="templates/importal.js"></script>
...
#-----[ BEFORE, ADD ]------------------------------------------
#
Portal powered by <a href="http://www.integramod.com/" target="_blank" class="copyright">IM Portal</a> &copy; 2005 IntegraMOD<br />
